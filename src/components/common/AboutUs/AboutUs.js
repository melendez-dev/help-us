  ...
  return (
    <Box>
      ...
      <Container>
        ...
        <Box mt={4}>
          <Typography variant="p" color="secondary">
            <b>Solidaridad:</b> Construimos un enfoque de preservación de los
            derechos fundamentales constitucionales, orientados a erradicar la
            desigualdad a través de acciones encaminadas a proteger la vivienda
            digna y el ambiente sano en la comunidad con la que trabajamos.
          </Typography>
        </Box>
        ...
        <Box mt={3}>
          <Typography variant="p" color="secondary">
            <b>Excelencia:</b> Aseguramos la consecución de nuestros objetivos y
            buscamos el mayor impacto de nuestras actuaciones a través de la
            calidad y la optimización de nuestras capacidades y recursos.
          </Typography>
        </Box>

        <Box mt={3}>
          <Typography variant="p" color="secondary">
            <b>Transparencia:</b> Basamos nuestra labor en la honestidad, la
            mutua responsabilidad y el máximo acceso a la información, como
            pilares de una rendición de cuentas social y económica ante nuestros
            colaboradores, donantes, beneficiarios y ante la sociedad en
            general.
          </Typography>
        </Box>
        ...
        <Box marginY={7} mt={3}>
          <Typography variant="p" color="secondary">
            <b>Unidad:</b> Creemos en el trabajo en equipo y en la colaboración
            con otras instituciones para potenciar sinergias y mejorar el
            rendimiento de nuestro trabajo.
          </Typography>
        </Box>
      </Container>
    </Box>
